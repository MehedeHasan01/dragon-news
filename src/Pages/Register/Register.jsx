...
const Register = () => {
        ...
        .then(res => {
            ...
            .then(()=>{
                ...
                if(user.emailVerified){
                    ...
                    swal( 'Please Chack You Email And Verify ','User Create SuccessFully!', 'success');
    ...
    return (
        <div className="bg-[#F3F3F3] h-fit">
            ...
            <div className=" max-w-6xl mx-auto py-2 mb-4 md:mb-0 md:py-5 font-poppins bg-titleColor">
                <Navbar/>
            </div>
